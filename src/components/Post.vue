    ...
    <div class="">
        <div class="card px-0 col-lg">
            ...
            <div class="card-body pt-2">
                ...
                <p class="card-text mt-1">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Perferendis impedit facilis nesciunt dolorem fugiat assumenda iusto porro, ut excepturi molestiae?</p>
                <p class="card-text"><small class="text-muted">3 часа назад</small></p>
            </div>
        </div>
    </div>
</template>
